...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBusinessException(BusinessException e) {
        ...
        return ResponseEntity.status(code.getStatusCode()).body(ApiResponse.fail(code));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleMethodArgumentNotValid(MethodArgumentNotValidException e) {
        ...
        return ResponseEntity.status(400).body(ApiResponse.fail(GeneralErrorCode.VALIDATION_ERROR));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleNoResourceFound(NoResourceFoundException e) {
        ...
        return ResponseEntity.status(404).body(ApiResponse.fail(GeneralErrorCode.NOT_FOUND));
    }

    @ExceptionHandler(HttpRequestMethodNotSupportedException.class)
    public ResponseEntity<ApiResponse<Void>> handleMethodNotSupported(HttpRequestMethodNotSupportedException e) {
        log.warn("MethodNotSupported: {}", e.getMessage());
        return ResponseEntity.status(405).body(ApiResponse.fail(GeneralErrorCode.METHOD_NOT_ALLOWED));
    }

    @ExceptionHandler(HttpMediaTypeNotSupportedException.class)
    public ResponseEntity<ApiResponse<Void>> handleMediaTypeNotSupported(HttpMediaTypeNotSupportedException e) {
        log.warn("MediaTypeNotSupported: {}", e.getMessage());
        return ResponseEntity.status(415).body(ApiResponse.fail(GeneralErrorCode.UNSUPPORTED_MEDIA_TYPE));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleTypeMismatch(Exception e) {
        ...
        return ResponseEntity.status(400).body(ApiResponse.fail(GeneralErrorCode.INVALID_REQUEST_PARAMETER));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleMessageNotReadable(HttpMessageNotReadableException e) {
        ...
        return ResponseEntity.status(400).body(ApiResponse.fail(GeneralErrorCode.BAD_REQUEST));
    }
    ...
    public ResponseEntity<ApiResponse<Void>> handleException(Exception e) {
        ...
        return ResponseEntity.status(500).body(ApiResponse.fail(GeneralErrorCode.INTERNAL_SERVER_ERROR));
    }
}
